...
working_dir = './data/miniImageNet'
data_path = join(working_dir, 'ILSVRC2015/Data/CLS-LOC/train')
...
for dataset in dataset_list:
    with open(join(working_dir, datasetmap[dataset] + ".csv"), "r") as lines:
...
fo = open(join(working_dir, "all.json"), "w")
