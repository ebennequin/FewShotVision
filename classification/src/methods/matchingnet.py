...
class MatchingNet(MetaTemplate): #TODO: check that LSTMs are still trained
    def __init__(self, model_func, n_way, n_support):
        ...
        self.loss_fn = nn.NLLLoss()  # TODO: why NNL here and CrossEntropy in ProtoNet ?
    ...
    def encode_training_set(self, S, G_encoder=None):  # TODO: make FCE optional, and extendable to ProtoNet
    ...
    def get_logprobs(self, f, G, G_normalized, Y_S, FCE=None):
        ...
        # TODO: computation of scores & loss is not justified in any algorithm and should be unified. Why logprobs here ?
